...
public class ControlPanel extends Frame 
{
  ...
  Label accessCounterLabel = new Label("0" , Label.LEFT) ;
  ...
  public void paintPage( Page page ) 
  {
    ...
    accessCounterLabel.setText(Integer.toString(page.accessCounter));
  }
