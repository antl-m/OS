...
template<>
struct op_group_traits<INT_SUM> :
    op_group_type_traits<int>
{
};

template<>
struct op_group_traits<INT_MULT> :
    op_group_type_traits<int>
{
};

template<>
struct op_group_traits<DOUBLE_SUM> :
    op_group_type_traits<double>
{
};

template<>
struct op_group_traits<DOUBLE_MULT> :
    op_group_type_traits<double>
{
};

template<>
struct op_group_traits<AND> :
    op_group_type_traits<bool>
{
};

template<>
struct op_group_traits<OR> :
    op_group_type_traits<bool>
{
};
...
//extern
template<op_group O>
typename op_group_traits<O>::result_type probe_f(int);

//extern
template<op_group O>
typename op_group_traits<O>::result_type probe_g(int);
